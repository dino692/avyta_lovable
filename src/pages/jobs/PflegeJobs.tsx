...
const stellenangebote = [
  ...
  { title: "Pflegehelfer/Pflegehelferin", href: "/karriere/pflegehelfer-frankfurt", icon: Heart },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Pflege Jobs Frankfurt | Karriere bei AVYTA Pflegedienst" />
