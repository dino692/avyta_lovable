...
const Intensivpflege = () => {
  return (
    <>
      <Helmet>
        <title>Intensivpflege Frankfurt ✓ Heimbeatmung | avyta.de</title>
        ...
        <meta property="og:title" content="Ausserklinische Intensivpflege in Frankfurt am Main mit Avyta" />
        <meta property="og:description" content="Für alle medizinischen und sozialen Leistungen rund um die ausserklinische Intensivpflege in Frankfurt am Main ist Avyta Ihr kompetenter Partner." />
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-base md:text-xl text-muted-foreground mb-6 md:mb-8 leading-relaxed">
                  Pflegebedürftig sein ist das eine – aber es gibt Fälle, in denen eine besonders enge medizinische Betreuung notwendig ist. Dennoch ist es auch für diese Patienten oft wichtig, nicht aus Ihrem gewohnten Umfeld gerissen zu werden. Hier kommt die <strong>ausserklinische Intensivpflege in Frankfurt am Main</strong> ins Spiel. Bei <Link to="/ueber-uns" className="text-primary hover:underline font-medium">Avyta</Link> können wir für Sie oder Ihre Angehörigen das gesamte Spektrum an <strong>intensivpflegerischen Leistungen</strong> übernehmen. Mit mehr als <strong>12 Jahren Erfahrung in der Pflege</strong> und einem <em><strong>hochmotivierten, verlässlichen</strong></em> und <em><strong>einfühlsamen</strong></em> Team stehen wir Ihnen in der <strong>ausserklinischen Intensivpflege</strong> in Frankfurt am Main zur Seite.
                </p>
