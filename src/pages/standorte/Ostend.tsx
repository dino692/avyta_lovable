  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Pflegedienst Ostend ✓ Professionelle ambulante Pflege ✓ Grund-, Behandlungs- & Intensivpflege ✓ 12+ Jahre Erfahrung ✓ 069 153 914 05" />
        ...
        <script type="application/ld+json">{generateServiceSchema({
          serviceName: "Ambulanter Pflegedienst Frankfurt Ostend",
          serviceDescription: "Ambulanter Pflegedienst in Frankfurt Ostend: Grundpflege, Behandlungspflege und Intensivpflege zu Hause.",
          serviceType: "Ambulanter Pflegedienst",
          canonicalUrl: "https://www.avyta.de/standorte/frankfurt/ostend",
        })}</script>
      </Helmet>
