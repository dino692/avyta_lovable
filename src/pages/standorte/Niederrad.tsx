...
const Niederrad = () => {
  return (
    <>
      <Helmet>
        <title>Pflegedienst Frankfurt Niederrad ✓ Pflege | avyta.de</title>
        ...
        <link rel="canonical" href="https://www.avyta.de/standorte/frankfurt/niederrad" />
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="prose prose-lg max-w-none text-muted-foreground">
                  ...
                  <p className="mb-6">
                    Mit dem <Link to="/ueber-uns" className="text-primary hover:underline font-medium">Avyta Pflegedienst</Link> in Frankfurt Niederrad erhalten Sie oder Ihre Angehörigen in Ihrer gewohnten häuslichen Umgebung eine attraktive Lebensqualität, da Sie nicht in ein Pflegeheim umziehen müssen. Sie oder Ihre Angehörigen können Ihre Eigenständigkeit behalten und gleichzeitig die bestmögliche Pflege erhalten, denn wir, der <strong>ambulante Pflegedienst in Frankfurt Niederrad</strong>, kommt zu Ihnen.
                  </p>
