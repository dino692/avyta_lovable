...
const Westend = () => {
  return (
    <>
      <Helmet>
        <title>Pflegedienst Westend ✓ Ambulante Pflege | avyta.de</title>
        <meta name="description" content="Pflegedienst Westend ✓ Erstklassige ambulante Pflege ✓ Grund-, Behandlungs- & Intensivpflege ✓ Diskret & professionell ✓ 069 153 914 05" />
        ...
        <script type="application/ld+json">{generateServiceSchema({
          serviceName: "Ambulanter Pflegedienst Frankfurt Westend",
          serviceDescription: "Ambulanter Pflegedienst in Frankfurt Westend: Grundpflege, Behandlungspflege und Intensivpflege zu Hause.",
          serviceType: "Ambulanter Pflegedienst",
          canonicalUrl: "https://www.avyta.de/standorte/frankfurt/westend",
        })}</script>
      </Helmet>
          ...
          <section className="py-20 bg-card/50">
            <div className="container mx-auto px-4">
              ...
              <p className="text-muted-foreground text-center max-w-3xl mx-auto mb-12">
                Der <strong>Pflegedienst Frankfurt Westend</strong> bietet ein umfassendes Leistungsspektrum – von der <Link to="/leistungen/grundpflege" className="text-primary hover:underline">Grundpflege</Link> über die <Link to="/leistungen/behandlungspflege" className="text-primary hover:underline">Behandlungspflege</Link> bis zur <Link to="/leistungen/ausserklinische-intensivpflege-frankfurt-am-main" className="text-primary hover:underline">Intensivpflege</Link>.
              </p>
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Entlastung für pflegende Angehörige im Westend. Mehr zur <Link to="/leistungen/verhinderungspflege-frankfurt" className="text-primary hover:underline">Verhinderungspflege</Link>.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
