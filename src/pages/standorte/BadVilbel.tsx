            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="prose prose-lg max-w-none text-muted-foreground">
                  ...
                  <p className="mb-6">
                    Wenn Sie sich für den <strong>ambulanten Pflegedienst</strong> in Bad Vilbel entscheiden, kann die Lebensqualität und der Alltag durch die bekannte Umgebung bestmöglich gewahrt werden. <Link to="/ueber-uns" className="text-primary hover:underline font-medium">Wir von AVYTA</Link> stellen einen an Ihren Bedürfnissen ausgerichteten Hilfsplan zusammen und bieten Ihnen so eine <strong>flexible</strong> und <strong>professionelle</strong> Unterstützung in allen Lebenslagen.
                  </p>
