...
import { Menu, X, Phone, ChevronDown, Briefcase, FileText, Users, UserCheck, Heart, HeartHandshake, Newspaper, Lightbulb, Scale, Activity, BookOpen, Stethoscope, HandHelping, HeartPulse, Home, Clock, MessageCircle, CalendarCheck, LucideIcon, Building2, MapPin, Mail, Calendar, Ambulance, ExternalLink, Award, ArrowRight } from "lucide-react";
        ...
        <div className={`relative h-full overflow-y-auto transition-all duration-500 ease-out ${
          ...
          <nav className="flex flex-col gap-1 p-5 pb-32">
            ...
            <div className="mb-1">
              ...
              <div className={`overflow-hidden transition-all duration-400 ease-out ${mobileJobsOpen ? 'max-h-[800px] opacity-100' : 'max-h-0 opacity-0'}`}>
                <div className="pl-6 pr-2 py-2 space-y-1">
                  {jobs.map((item, index) => (
                    <Link
                      key={item.name}
