...
const stadtteile = [
  ...
  { name: "Ginnheim", link: "/pflegedienst-ginnheim" },
  { name: "Griesheim", link: "/pflegedienst-griesheim" },
  { name: "Heddernheim", link: "/pflegedienst-heddernheim" },
  { name: "Höchst", link: "/pflegedienst-frankfurt-hoechst" },
  { name: "Nieder-Eschbach", link: "/pflegedienst-nieder-eschbach" },
  { name: "Niederrad", link: "/pflegedienst-niederrad" },
  { name: "Nordend", link: "/pflegedienst-nordend" },
  { name: "Ostend", link: "/pflegedienst-ostend" },
  { name: "Praunheim", link: "/pflegedienst-praunheim" },
  { name: "Preungesheim", link: "/pflegedienst-preungesheim" },
  { name: "Rödelheim", link: "/pflegedienst-roedelheim" },
  { name: "Sachsenhausen", link: "/pflegedienst-frankfurt-sachsenhausen" },
