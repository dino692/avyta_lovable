...
const socialLinks = [
  { name: "Facebook", Icon: Facebook, href: "https://www.facebook.com/avytapflege" },
  { name: "Instagram", Icon: Instagram, href: "https://www.instagram.com/avyta_pflegedienst/" },
  { name: "TikTok", Icon: TikTokIcon, href: "https://www.tiktok.com/@avyta0" },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 pb-12 border-b border-background/10">
          <div className="lg:col-span-2 space-y-6">
            <Link to="/" className="flex items-center gap-2">
              <img src="/images/avyta-logo.png" alt="AVYTA Pflegegesellschaft mbH" className="h-10 brightness-0 invert" />
            </Link>
